...
The `update-exim4.conf` command will update the auto-generated configuration file stored in `/var/lib/exim4/config.autogenerated`. This is the actual configuration file that Exim4 uses.
