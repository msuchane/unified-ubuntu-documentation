...
Package managers
: On Ubuntu Desktop, you can manage snaps using the App Center. See {ref}`install-an-application`.
...
Package managers
: On Ubuntu Desktop, you can manage debs using the App Center. See {ref}`install-an-application`.
