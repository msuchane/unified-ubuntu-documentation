...
1. When App Center launches, search for an application, or select a category and find an application from the list.

1. Select the application that you want to install and click {guilabel}`Install`.

1. App Center asks you to enter your password. Once you've done that, the installation begins.
