...
Set up your LMA stack <set-up-your-lma-stack>
Install Logwatch <install-logwatch>
Install Munin <install-munin>
Install Nagios Core 3 <install-nagios>
Use Nagios with Munin <use-nagios-with-munin>
```
