...
1. Open the *Language Support* application.
    ...
    You can also access the application from {menuselection}`Settings --> System --> Region & Language --> Manage Installed Languages`.

1. Click {guilabel}`Install / Remove Languages…`.

    The Installed Languages window lists all the available languages, with the currently installed languages checked.

1. Check the languages that you want to install, and uncheck those currently installed languages that you want to remove.

1. Click {guilabel}`Apply`.

1. Enter your password, or the password for the requested administrator account.
