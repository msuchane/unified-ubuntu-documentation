...
* **Logical volumes**: correspond to partitions – they usually hold a {term}`filesystem`. Unlike partitions though, they can span multiple disks (because of the way volume groups are organized) and do not have to be physically contiguous.
