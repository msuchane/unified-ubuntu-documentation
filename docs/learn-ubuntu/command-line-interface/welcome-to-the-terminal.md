...
If you wish, you can continue to explore the file system on your virtual machine, or proceed straight to the next tutorial where you can use the same VM.
